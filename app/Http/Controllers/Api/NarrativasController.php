        ...
        */
        ...
        if ($user->isAdmin()) {
            $validator = Validator::make($request->all(), [
                ...
                ],*/ //ERROR:  no existe la columna «semestre»
            ]);
            ...
            $narrative->registration_status_id = RegistrationStatusModel::registrationId("activo");
            //echo 'date_id: ' . $narrative->registration_status_id . '';
            $narrative->save();
            return response([
